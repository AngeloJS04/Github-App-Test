...
const AuthPage = () => {
    ...
    const oAuth = async (name: TypeProvider) => {
        ...
        const token = getResultCredentialToken(name, userCredential);
        if(!token) return;
    ...
    return (
        <div className='flex flex-col items-center mt-10'>
            <svg height="80" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="68" data-view-component="true" >
            ...
            <span className='my-5'>Sign in to GitHub</span>
            <button onClick={() => oAuth("github")} className='bg-green-700 hover:bg-green-600 text-white rounded-md px-4 py-2 flex items-center' >
